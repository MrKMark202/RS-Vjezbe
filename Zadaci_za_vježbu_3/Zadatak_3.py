...
parni_kvadrati = [x for x in range(20,50) if x%2==0]
...
# Koristeći list comprehension, izgradite listu rječnika gdje su ključevi brojevi od 1 do 10, a vrijednosti su
