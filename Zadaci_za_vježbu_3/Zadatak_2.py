...
# Koristeći funckiju filter, filtrirate samo brojeve koji su veći od 5
...
min_duljina = input("Unesite minimalnu duljinu rijeci: ")
duge_rijeci = list(filter(lambda rijec : len(rijec) > len(min_duljina), rijeci))
print(duge_rijeci)